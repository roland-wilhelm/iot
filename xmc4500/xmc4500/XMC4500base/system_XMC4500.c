...
uint32_t SystemCoreClock = SYSTEM_FREQUENCY;
#else
...
{
  /* needs to check the clock registers to calculate the current Core Clock! */
...
#else
  SystemCoreClock = CLOCK_OSC_HP;/*!< System Clock Frequency (Core Clock)*/
#endif
