...
armcc -g -O2 -I..\include -c --cpu Cortex-M3 svc.c -o svc.o
armlink --inline --scatter=scatter.scat --info=unused main.o exceptions.o retarget.o uart.o pseudo_intrinsics.o scs.o timer.o svc.o -o build4.axf
pause
