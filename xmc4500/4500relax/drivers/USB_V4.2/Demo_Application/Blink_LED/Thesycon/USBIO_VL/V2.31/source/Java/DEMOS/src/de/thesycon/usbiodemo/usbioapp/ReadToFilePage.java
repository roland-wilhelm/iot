...
public class ReadToFilePage extends PanelPage {

	public String getPageName() { return "Read from Pipe to File"; };

	protected PipeDlgToFile mainFrame;
	...
	public ReadToFilePage(PipeDlgToFile Frame) {
		mainFrame = Frame;
	}
	...
	public void initGUIelements() {
		...
		mBrowsePanel.setBorder(BorderFactory.createTitledBorder("Destination File"));
