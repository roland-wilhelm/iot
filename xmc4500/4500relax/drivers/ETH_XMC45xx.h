...
#include "RTL.h"
#include "../../xmc4500/base_ao/Network/uip_ao.h" 
...
#define GmiiDevMask 0x0000F800     /* (PA)GMII device address                 15:11     RW         0x00    */
#define GmiiDevShift 11
#define GmiiRegMask 0x000007C0     /* (GR)GMII register in selected Phy       10:6      RW         0x00    */
#define GmiiRegShift 6
#define GmiiBusy 0x00000001  
#define GmiiWrite 0x00000002
#define GmiiRead  0x00000000
...
#define KSZ8031RLN_DEF_ADR	0x0002				/* Default PHY device address        */
#define KSZ8031RLN_ID 			0x22			// MICREL OUI
#define KSZ8031RLN_PHY_AUTO_NEG        0x1000      /* Select Auto Negotiation           */


#define RECEIVE_ERROR 0x1
#define RECEIVE_FINISH 0x2
#define RECEIVE_MORE_TO_FETCH 0x4

void init_ethernet (void);
unsigned int receive(unsigned char *buffer, unsigned char *rStatus);
void send_frame2 (IP_Event *ip_evt);
void Release_Current_Frame(void);
